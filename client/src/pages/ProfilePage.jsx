...
const ProfilePage = () => {
    ...
    useEffect(() => {
        ...
        if (!myId) {
            toast.error("Bạn cần đăng nhập để xem hồ sơ này!");
            setIsLoading(false);
    ...
    const handleFollowUser = async () => {
        try {
            ...
            { console.log(e); toast.error("Lỗi khi thao tác theo dõi!"); }
    };
                            ...
                            <div className="action-menu-wrapper" style={{ position: 'relative' }}>
                                ...
                                {isMenuOpen && (
                                    <div className="dropdown-menu-container" style={{ top: '100%', right: 0 }} onClick={e => e.stopPropagation()}>
                                        ...
                                        <button onClick={() => toast.error("Tính năng báo cáo đang phát triển")} className="dropdown-item report">
