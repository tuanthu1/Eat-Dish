...
const SettingView = ({ user }) => {
    ...
    const handleSubmitFeedback = async () => {
        ...
        try {
            ...
            toast.success("Cảm ơn bạn! Góp ý đã được gửi thành công. ❤️"); setFeedbackData({ type: 'Lỗi ứng dụng', content: '' }); setActiveTab('main');
            ...
            {activeTab === 'main' && (
                <>
                    ...
                    <div className="setting-content-card">
                        ...
                        <div className="setting-menu-row no-border" onClick={handleLogout}><span>🚪 Đăng xuất</span></div>
                    </div>
                </>
            )}
